...
// HasLedClubs applies the HasEdge predicate on the "led_clubs" edge.
func HasLedClubs() predicate.User {
...
// HasLedClubsWith applies the HasEdge predicate on the "led_clubs" edge with a given conditions (other predicates).
func HasLedClubsWith(preds ...predicate.Club) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newLedClubsStep()
