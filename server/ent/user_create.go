...
func (_c *UserCreate) AddLedClubIDs(ids ...int) *UserCreate {
	_c.mutation.AddLedClubIDs(ids...)
	return _c
}

// AddLedClubs adds the "led_clubs" edges to the Club entity.
func (_c *UserCreate) AddLedClubs(v ...*Club) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddLedClubIDs(ids...)
}

// AddAnswerIDs adds the "answers" edge to the Answer entity by IDs.
func (_c *UserCreate) AddAnswerIDs(ids ...int) *UserCreate {
	_c.mutation.AddAnswerIDs(ids...)
	return _c
}

// AddAnswers adds the "answers" edges to the Answer entity.
func (_c *UserCreate) AddAnswers(v ...*Answer) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.LedClubsIDs(); len(nodes) > 0 {
