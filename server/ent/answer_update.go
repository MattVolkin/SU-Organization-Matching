...
func (_u *AnswerUpdate) SetNillableAnswerText(v *string) *AnswerUpdate {
	if v != nil {
		_u.SetAnswerText(*v)
	}
	return _u
...
func (_u *AnswerUpdate) SetSubmittedAt(v time.Time) *AnswerUpdate {
	_u.mutation.SetSubmittedAt(v)
	return _u
}

// SetNillableSubmittedAt sets the "submitted_at" field if the given value is not nil.
func (_u *AnswerUpdate) SetNillableSubmittedAt(v *time.Time) *AnswerUpdate {
	if v != nil {
		_u.SetSubmittedAt(*v)
	}
	return _u
...
// SetNillableAnswerText sets the "answer_text" field if the given value is not nil.
func (_u *AnswerUpdateOne) SetNillableAnswerText(v *string) *AnswerUpdateOne {
	if v != nil {
		_u.SetAnswerText(*v)
	}
	return _u
...
// SetSubmittedAt sets the "submitted_at" field.
func (_u *AnswerUpdateOne) SetSubmittedAt(v time.Time) *AnswerUpdateOne {
	_u.mutation.SetSubmittedAt(v)
	return _u
}

// SetNillableSubmittedAt sets the "submitted_at" field if the given value is not nil.
func (_u *AnswerUpdateOne) SetNillableSubmittedAt(v *time.Time) *AnswerUpdateOne {
	if v != nil {
		_u.SetSubmittedAt(*v)
	}
	return _u
